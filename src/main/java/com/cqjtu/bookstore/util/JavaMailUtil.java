...
public class JavaMailUtil {
	...
	// 发件人的邮箱和密码
	public static String emailAccount = "2776211598@qq.com";
	// 发件人邮箱密码（有的是授权码）
	public static String emailPassword = "jkkqkegjilmqdehe";
	// 发件人邮箱服务地址
	...
	public static  MimeMessage creatMimeMessage(Session session,String sendMail,String receiveMail,String html) throws MessagingException, IOException {
		...
		// 2、From：发件人
		message.setFrom(new InternetAddress(sendMail, "墨韵书城", "UTF-8"));
