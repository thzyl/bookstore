		...
		<div class="rank-box box-center cf">
			...
			<div class="main-content-wrap fl">
				<div class="rank-header inner-wrap">
					<h3 class="lang">收藏榜</h3>
					<ul class="type cf rank-tab-box">
						<li><a
							href="http://localhost:8080/bookstore/novel/collection.html?style=全部">全部</a></li>
						<li><a
							href="http://localhost:8080/bookstore/novel/collection.html?style=言情">言情</a></li>
						<li><a
							href="http://localhost:8080/bookstore/novel/collection.html?style=武侠">武侠</a></li>
						<li><a
							href="http://localhost:8080/bookstore/novel/collection.html?style=青春">青春</a></li>
						<li><a
							href="http://localhost:8080/bookstore/novel/collection.html?style=玄幻">玄幻</a></li>
						<li><a
							href="http://localhost:8080/bookstore/novel/collection.html?style=仙侠">仙侠</a></li>
						<li><a
							href="http://localhost:8080/bookstore/novel/collection.html?style=悬疑">悬疑</a></li>
						<li><a
							href="http://localhost:8080/bookstore/novel/collection.html?style=科幻">科幻</a></li>
						<li><a
							href="http://localhost:8080/bookstore/novel/collection.html?style=玄幻">玄幻</a></li>
						<li><a
							href="http://localhost:8080/bookstore/novel/collection.html?style=都市">都市</a></li>
						<li><a
							href="http://localhost:8080/bookstore/novel/collection.html?style=历史">历史</a></li>
						<li><a
							href="http://localhost:8080/bookstore/novel/collection.html?style=轻小说">轻小说</a></li>
					</ul>
					<ul class="type cf rank-tab-box">
					</ul>
				</div>
