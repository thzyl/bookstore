...
<script src="resources/js/jquery-3.2.1.min.js" type="text/javascript"
					...
					<div class="select-list">
						<div class="work-filter type-filter">
							<ul type="size" style="height: 40px;">
								...
								function showDiv()
						  			{								
									window.location.href="../novel/all.html?style="+$("#select1").val()+"&status="+$("#select2").val()+"&attribute="+$("#select3").val()+"";
								    } 
								  ...
								  console.log(num);
									...
									if(num/pageSize>parseInt(num/pageSize)){
										...
										document.getElementById("select1").value="${novelstyle}"; 
								  		document.getElementById("select2").value="${novelstatus}"; 
						...
						<div class="work-filter">
							...
							<ul type="size" style="height: 40px;">
								<li data-id="6" class=""><h2>状态</h2></li>
								<li data-id="6" class="" style="width: 120px;"><select
									style="width: 100px;" id="select2" onchange="showDiv()">
										<option>全部</option>
										<option>连载</option>
										<option>完本</option>
								</select></li>
						...
						<ul id="idData">
							<c:forEach items="${novel}" var="t">
								<li>
									...
									<div class="book-info">
										<a href="../home/synopsis.html?novelId=${t.novelId}"><h1
												action="${basePath}novel/all.html" method="post">${t.novelName}</a>
										</h1>
										<h4>
										...
										<p class="tag">
											<span class="org">${t.novelStyle}</span><span class="red">${t.novelStatus}</span><span
												class="blue">${t.novelAttribute}</span><span class="blue">${t.novelCount}</span>
										</p>
