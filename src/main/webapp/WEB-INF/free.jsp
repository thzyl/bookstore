					...
					<div class="select-list">
						<div class="work-filter type-filter">
							<ul type="size" style="height: 40px;">
								...
								function showDiv()
						  			{					
									window.location.href="../novel/free.html?style="+$("#select1").val()+"&status="+$("#select2").val()+"";
								    } 
							...
							<c:forEach items="${novelInfo}" var="t">
								<li>
									...
									<div class="book-info">
										...
										<p class="tag">
											<span class="org">${t.novelStyle}</span><span class="org">${t.novelStatus}</span><span
												class="red">${t.novelAttribute}</span><span class="blue">${t.novelCount}</span>
										</p>
